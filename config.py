...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/GARIB-CODERS/SPOTIFY_MUSIC",
)
...
# ------------------------------------------------------------------------
# -------------------------------------------------------------------------
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/+XSOc2neT509kOTA9")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+XSOc2neT509kOTA9")
SOURCE = getenv("SOURCE", "https://github.com/GARIB-CODERS/SPOTIFY_MUSIC")
CHAT = getenv("CHAT", "https://t.me/+XSOc2neT509kOTA9")
# ------------------------------------------------------------------------------
# -------------------------------------------------------------------------------
